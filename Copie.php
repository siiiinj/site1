...
<body>
  ...
  <script src="js/app.js"></script>
    ...
    <div id="video">
    <video id="myVidea" autoplay loop shuffle muted>

      <source src="vidéo/trailer-foodwars.mp4" type="video/mp4" aria-hidden="true" >
    </video>
  </div>
  <script>
      ...
      <div class="thumbTiles swiper-container">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              ...
              <div class="swiper-slide">
                <a class="thumbTile" href="#fatezero">        
                   <img class="thumbTile__image" src='wallpaper anime/wallpaperfate.png' onmouseover="this.src='wallpaper anime/wallpaperfatedegtest.png';" onmouseout="this.src='wallpaper anime/wallpaperfate.png';" />  
